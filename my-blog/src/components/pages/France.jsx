...
const France = () => {
   ...
   <div className="Title"><h1>France</h1></div>
      ...
      <div className="France-about">
        ...
        alpine villages and Mediterranean beaches. Paris, its capital, is famed for its fashion 
        houses, classical art museums including the Louvre and monuments like the Eiffel Tower. 
